...
# Slot declaration is valid just remember how it translates. And note that
# its essentially useless.
let z: int if some_condition;
if some_condition { let z: int; }

# Adding an else clause to the postfixed if turns it into a ternary operator.
let w = 32 if some_condition else 83;
